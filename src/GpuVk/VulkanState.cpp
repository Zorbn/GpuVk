...
void VulkanState::Init(SDL_Window* window)
{
...
void VulkanState::CreateInstance(SDL_Window* window)
{
...
void VulkanState::CreateAllocator()
{
...
std::vector<const char*> VulkanState::GetRequiredExtensions(SDL_Window* window)
{
...
void VulkanState::IncrementFrame()
{
    _currentFrame = (_currentFrame + 1) % MaxFramesInFlight;
    Gpu.Commands.SetCurrentBufferIndex(_currentFrame);
}

VkSemaphore VulkanState::GetCurrentImageAvailableSemaphore() const
{
    return _imageAvailableSemaphores[_currentFrame];
}

VkSemaphore VulkanState::GetCurrentRenderFinishedSemaphore() const
{
    return _renderFinishedSemaphores[_currentFrame];
}

const VkFence& VulkanState::GetCurrentInFlightFence() const
{
...
bool VulkanState::IsDeviceSuitable(VkPhysicalDevice device)
{
    ...
    if (extensionsSupported)
    {
        SwapchainSupportDetails swapchainSupport =
            Gpu.Swapchain.QuerySupport(device, Surface);
